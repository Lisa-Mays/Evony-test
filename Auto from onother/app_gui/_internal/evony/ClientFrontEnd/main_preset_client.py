...
def save_button_click():
    ...
    with open(f'../config/preset.json', 'w') as file:
...
save_button.config(command=save_button_click)
...
input_entry = tk.Entry(group_frame2)
input_entry.grid(row=2, column=0, padx=2, pady=2, sticky="w")
